...
<jsp:useBean id="navBar" class="com.dianping.phoenix.view.NavigationBar" scope="page" />
...
<head>
	...
	<link href="${model.webapp}/inspect/css/bootstrap.css" type="text/css" rel="stylesheet">
	<link href="${model.webapp}/inspect/css/bootstrap-responsive.css" type="text/css" rel="stylesheet">
	<script src="${model.webapp}/inspect/js/jquery-1.8.3.min.js" type="text/javascript"></script>
...
<body data-spy="scroll" data-target=".subnav" data-offset="50">
	...
	<div class="container-fluid" style="min-height:524px;">
		...
		<br />
		<div class="container">
			<footer><center>&copy;2013 Dianping Phoenix Team</center></footer>
		</div>
	</div>
	<!--/.fluid-container-->

	<script src="${model.webapp}/inspect/js/bootstrap.js" type="text/javascript"></script>
</body>
</html>
