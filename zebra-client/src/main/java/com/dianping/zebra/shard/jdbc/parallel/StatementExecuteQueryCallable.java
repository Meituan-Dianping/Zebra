...
public class StatementExecuteQueryCallable implements Callable<List<ResultSet>> {
	...
	public StatementExecuteQueryCallable(Map<String, Statement> sqlStmtMap, boolean forceMaster) {
		super();
