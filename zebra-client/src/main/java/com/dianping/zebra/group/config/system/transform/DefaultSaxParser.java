...
public class DefaultSaxParser extends DefaultHandler {
	...
	private void parseForSqlFlowControl(SqlFlowControl parentObj, String parentTag, String qName, Attributes attributes)
	      throws SAXException {
		m_objs.push(parentObj);
		m_tags.push(qName);
	}

	private void parseForSystemConfig(SystemConfig parentObj, String parentTag, String qName, Attributes attributes)
	      throws SAXException {
