...
public class SQLThreadPoolExecutorTest {
	...
	@Before
	public  void prepare() {
		SQLThreadPoolExecutor.writeCorePoolSize = 3;
		SQLThreadPoolExecutor.writeMaxPoolSize = 3;
		SQLThreadPoolExecutor.writeExecuteTimeOut = 1000L;
	}

	@Test
	public void testNormal() {
		SQLThreadPoolExecutor instance = SQLThreadPoolExecutor.getInstance(false);
